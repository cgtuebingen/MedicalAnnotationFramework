...
class LabelingMainWindow(QMainWindow):
    ...
    def define_wsi_actions(self):
        actions = (Action(self,
                          ...
                          lambda: (self.file_display.annotations.set_mode(0),
                                   self.file_display.annotations.set_type('polygon'),
                                   self.file_display.set_annotation_mode(False)),
                          icon="mouse",
                          tip="Select items in the image",
                          checkable=True,
                          checked=True),
                   Action(self,
                          ...
                          lambda: (self.file_display.annotations.set_mode(1),
                                   self.file_display.annotations.set_type('polygon'),
                                   self.file_display.set_annotation_mode(True)),                          icon="polygon",
                          tip="Draw Polygon",
                          checkable=True),
                   Action(self,
                          "Draw\nTrace",
                          lambda: (self.file_display.annotations.set_mode(1),
                                   self.file_display.annotations.set_type('trace'),
                                   self.file_display.set_annotation_mode(True)),
                          icon="outline",
                          tip="Trace Outline",
                          checkable=True),
                   Action(self,
                          ...
                          lambda: (self.file_display.annotations.set_mode(1),
                                   self.file_display.annotations.set_type('ellipse'),
                                   self.file_display.set_annotation_mode(True)),                          icon="ellipse",
                          tip="Draw Ellipse",
                          checkable=True),
                    Action(self,
                          "Draw\nCircle",
                          lambda: (self.file_display.annotations.set_mode(1),
                                   self.file_display.annotations.set_type('circle'),
                                   self.file_display.set_annotation_mode(True)),                          icon="circle",
                          tip="Draw Circle",
                          checkable=True),
                   Action(self,
                          "Draw\nRectangle",
                          lambda: (self.file_display.annotations.set_mode(1),
                                   self.file_display.annotations.set_type('rectangle'),
                                   self.file_display.set_annotation_mode(True)),                          icon="square",
                          tip="Draw Rectangle",
                          checkable=True))
        actions = list(actions)
        return actions
